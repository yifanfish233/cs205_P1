...
def general_search(problem, queueing_function, heuristic_function=None, show_info=False):
    ...
    while nodes:
        ...
        nodes = queueing_function(nodes, next_states, visited, cost, heuristic_function)  # Pass heuristic_function here
...
def search_queueing_function(nodes, next_states, visited, current_cost, heuristic_function=None):
    for successor in next_states:
        ...
        if state_str not in visited:
            heuristic = heuristic_function(successor.state) if heuristic_function else 0  # Pass successor.state
...
if __name__ == "__main__":
    ...
    #         [6, 3, 0]
    #     ]
    #     # Add the remaining initial states here
    # ]
